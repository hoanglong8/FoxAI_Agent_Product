...
|----|-------------------------------------------|-----------------------------------------------|--------------|---------|
| 1  | Basic Skills for Programming             | Giới thiệu các công cụ lập trình như Google, Chatbot, Colab, Overleaf và viết chương trình Python đầu tiên. | [Google Developers - Python](https://developers.google.com/edu/python) | Elementary |
| 2  | Basic Python (1)                         | Tìm hiểu về kiểu dữ liệu, các hàm built-in cơ bản và nâng cao trong Python. | [W3Schools - Python Basics](https://www.w3schools.com/python/) | Elementary |
| 3  | Math and Python (1) - Logarithm and Exponential Functions | Giới thiệu về logarit và hàm mũ, ứng dụng trong lập trình Python. | [Khan Academy - Logarithms](https://www.khanacademy.org/math/algebra/x2f8bb11595b61c86:exp-log) | Elementary |
| 4  | Basic Python (2) - For Loop and List     | Học cách sử dụng vòng lặp `for` và danh sách (list) trong Python. | [Real Python - Python Loops](https://realpython.com/python-for-loop/) | Elementary |
| 5  | Review on List and Functions             | Ôn tập về danh sách (list) và các hàm (functions) trong Python. | [Python Docs - Functions](https://docs.python.org/3/tutorial/controlflow.html#defining-functions) | Elementary |
| 6  | Build-in List Functions and Application  | Tìm hiểu các hàm built-in quan trọng cho danh sách và cách ứng dụng chúng. | [Python Docs - Built-in Functions](https://docs.python.org/3/library/functions.html) | Elementary |
| 7  | Algorithms on List                       | Giới thiệu các thuật toán xử lý danh sách, bao gồm sắp xếp và tìm kiếm. | [GeeksforGeeks - List Algorithms](https://www.geeksforgeeks.org/python-list/) | Intermediate |
| 8  | Project: Python Library and Deployment   | Làm việc với thư viện Python, đóng gói và triển khai một dự án nhỏ. | [Python Packaging Guide](https://packaging.python.org/en/latest/) | Elementary |
| 9  | Image Data and Numpy                     | Xử lý dữ liệu hình ảnh và sử dụng thư viện NumPy để thao tác dữ liệu số. | [NumPy Guide](https://numpy.org/doc/stable/user/quickstart.html) | Intermediate |
| 10 | Basic Linear Algebra                     | Ôn tập đại số tuyến tính, ma trận và vector, nền tảng quan trọng cho Machine Learning. | [MIT OpenCourseWare - Linear Algebra](https://ocw.mit.edu/courses/mathematics/18-06-linear-algebra-spring-2010/) | Elementary | 
| 11 | Steps to Linear Regression               | Các bước xây dựng mô hình hồi quy tuyến tính từ dữ liệu. | [StatQuest - Linear Regression](https://statquest.org/video-index/#regression) | Elementary |
| 12 | Linear Regression                        | Hiểu về hồi quy tuyến tính, phương pháp tối ưu hóa, độ lỗi và ứng dụng thực tế. | [Coursera - Regression Models](https://www.coursera.org/learn/regression-models) | Elementary |
| 13 | Exercise - Linear Regression             | Bài tập thực hành xây dựng mô hình hồi quy tuyến tính trên tập dữ liệu thực tế. | [Hands-On Machine Learning (Ch.4)](https://www.oreilly.com/library/view/hands-on-machine-learning/9781492032632/) | Elementary |
| 14 | Vector/Matrix for Linear Regression      | Ứng dụng ma trận và vector trong việc giải quyết bài toán hồi quy tuyến tính. | [DeepAI - Linear Algebra for ML](https://deepai.org/machine-learning-glossary-and-terms/linear-algebra) | Elementary |
